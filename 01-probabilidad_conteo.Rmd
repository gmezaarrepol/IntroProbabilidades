...
(X) A menudo es más fácil pensar que los experimentos están en orden cronológico, pero no hay ningún requisito en la regla de multiplicación de que el Experimento A debe realizarse antes que el Experimento B.


(ref: treeDiagram) Diagrama de árbol que ilustra la regla de multiplicación. Si el Experimento "A" tiene 3 resultados posibles, para cada uno de los cuales el Experimento "B" tiene 4 resultados posibles, entonces en general hay 3 · 4 = 12 resultados posibles.


```{r , out.width='40%', echo = FALSE, fig.align='center', fig.cap='Diagrama de árbol que ilustra la regla de multiplicación. Si el Experimento "A" tiene 3 resultados posibles, para cada uno de los cuales el Experimento "B" tiene 4 resultados posibles, entonces en general hay 3 · 4 = 12 resultados posibles.'}
...
$Solución$: Hay 10 posibilidades para quién obtiene el primer lugar, luego, una vez que se arregla, hay 9 posibilidades para quién obtiene el segundo lugar, y una vez que ambos se arreglan hay 8 posibilidades para el tercer puesto. Entonces, según la regla de la multiplicación, hay 10 · 9 · 8 = 720 posibilidades.